...
# querying for cryptic and annotated STMN2 reads --------------------------

  #STMN2_cryptic_query <- count_query(gene_name = "STMN2", 
      #snapcount_coords = "chr8:79611215-79616821", strand_code = "+")
  #STMN2_anno_query <- count_query(gene_name = "STMN2", 
      #snapcount_coords = "chr8:79611215-79636801", strand_code = "+")
...
# cryptic STMN2 expression in different cancer sites ----------------------
...
# barplot - fraction of cases of each cancer that have cryptic STM --------
...
# fraction of mutations in each cancer found in cryptic cases -------------
...
# survival status column in STMN2 survival df
