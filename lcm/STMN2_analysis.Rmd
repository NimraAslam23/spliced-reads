...
```{r querying for cryptic and annotated STMN2 reads, include = FALSE}
...
```{r bar plot - cancer types with STMN2 events, primary sites with cryptic, out.width="50%", echo = FALSE}
...
```{r boxplot - STMN2 junction coverage, out.width = "50%", echo = FALSE, warning = FALSE}
...
```{r where are the cancers with cryptic STMN2 events located?, out.width = "90%", echo = FALSE}
...
```{r survival status column in STMN2 survival df, include = FALSE}
