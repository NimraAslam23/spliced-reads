...
```{r querying for cryptic and annotated ARHGAP32 reads, include = FALSE}
...
**Figure 1**: ARHGAP32 is expressed in mostly breast and head/neck cancer patients.
...
**Figure 2**: (a) Cryptic ARHGAP32 events are found mostly in breast cancers. (b) Cryptic ARHGAP32 events are found most abundantly in cancers of the breast.
...
The majority of the cryptic ARHGAP32 events are expressed in BRCA (19.9% of cryptic cases), consistent with previous results. 
...
Table 3 shows that 82% of the mutations in ESCA (esophageal carcinoma) are seen in cases with cryptic ARHGAP32. This is the largest proportion out of all cancer subsets. 27.1% of all mutation in BRCA patients are in cases with cryptic ARHGAP32 events. 
...
There is no significant difference in aneuploidy score in cases with cryptic ARHGAP32 expression and non-cryptic cases for the majority of cancer types, indicating that the cryptic expression does not influence chromosome number. However, aneuploidy score is seemingly higher in non-cryptic HNSC (p = 0.058) and non-cryptic PRAD (p = 0.035) cases. 