...
```{r ARHGAP32 cryptic coverage vs mutation count, echo = FALSE}
...
```{r fraction of mutations in each cancer type that is found in cases with ARHGAP32 cryptic, include = FALSE}
...
```{r calculating mutation burden, echo = FALSE}
cBio_clinical |>
...
```{r survival status column in ARHGAP32 survival df, include = FALSE}
...
```{r survival KM curve for cases with ARHGAP32 cryptic, echo = FALSE}
...
```{r survival KM curve for cases with no ARHGAP32 cryptic, echo = FALSE}
survfit(Surv(months_of_disease_specific_survival, disease_specific_survival_status) ~ 1, 
...
```{r survival KM curves ARHGAP32 - both cryptic and non, echo = FALSE}
...
```{r density plot - months survival in cryptic vs non-cryptic ARHGAP32, echo = FALSE}
