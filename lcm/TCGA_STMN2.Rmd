...
```{r boxplot - overall STMN2 junction coverage in different cancer sites, echo = FALSE}
STMN2_clinical_jir_cryptic |> 
  ...
  geom_signif(comparisons = list(c("Stomach", "Breast"), c("Stomach", "Brain")),
              ...
              y_position = c(75, 80))
```
**Figure 1**: Stomach and breast cancers are the most deeply sequenced.
...
```{r bar plot - cancer types with cryptic STMN2 events, include = FALSE}

# Cancers with general STMN2 expression
...
# Figure X: STMN2 events are found mostly in breast and brain cancer patients. 
...
```{r fraction of mutations in each cancer type that is found in cases with cryptic}
...
```{r alculating mutation burden (weighting total mutations against total cases) for general vs cryptic}
...
```{r barplot - % of cases of each cancer that have cryptic STMN2, echo = FALSE}
